	...
	function Genetic() {
		...
		this.start = function() {
			...
			*/
		    ...
		    if(ent.hunterSpeed >= ent.preySpeed && Math.random() <= 0.98){ //// % chance hunter will catch prey based on speed vs speed
          if(ent.hunterStrength >= ent.preyArmour){ //// % change hunter will eat prey base on strength vs armour
            ent.hunterFitness++;
